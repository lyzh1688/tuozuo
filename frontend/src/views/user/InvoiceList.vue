...
import { fuzzyQueryCompany, getInvoiceList } from '@/api/company'
...
function fetch (value, callback) {
  ...
  function fake () {
    fuzzyQueryCompany(value, 20, true).then(d => {
  ...
  data () {
    ...
    return {
      ...
      loadData: parameter => {
        ...
        return getInvoiceList(requestParameters.beginMonth, requestParameters.endMonth, requestParameters.companyId, requestParameters.pageNo, requestParameters.pageSize)
          .then(Response => {
