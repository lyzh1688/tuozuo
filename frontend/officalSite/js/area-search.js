    ...
    SearchTip.prototype.start = function (t) {
        ...
        SearchTip.prototype.defaultIndustryClick = function () {
            ...
            this.$body.append(this.$defaultDom),
                $("dd span", this.$defaultDom).on("click", function () {
                    ...
                    $("#area-Keyword", this.result).val(i.id).data("v", i.id).blur(),
        ...
        SearchTip.prototype.bindInput = function () {
            return _config = {
                ...
                this.$input = $("#area-Keyword", this.result),
                ...
                this.$input.siblings(".area.arrow-down").on("click", function () {
        ...
        SearchTip.prototype.bindClick = function () {
            $("li", _config.$ul).on("click", function () {
                ...
                _config.$ul.parent().hide(),
                    $("#area-Keyword", _this.result).val(t.text()).data("v", JSON.stringify(t.text()))
            }),
        ...
        SearchTip.prototype.confirm = function () {
            ...
            i.index() != -1 && $("#area-Keyword", t.result).val(i.text()).data("v", JSON.stringify(i.text())),
                _config.$ul.hide()
        }
        ,
        window.areaSearchTip = SearchTip
}();
